...
<title>:: Owutech Portal :: Check Admission Status</title>
<!-- Favicon-->
        ...
        <div class="col-lg-4" style="display: block; margin-left: auto;margin-right: auto;" >
                <form class="card auth_form" method="POST" action="../backend/checkstatus.php">
                    ...
                    <img class="logo" src="assets/images/logo.png" alt="">
                       <strong> <h5>Check Admission Status </h5></strong>
                        <br>
                    ...
                    <div class="body">
                        ...
                        <button type="submit" class="btn btn-success btn-block waves-effect waves-light">Search Records </button>
