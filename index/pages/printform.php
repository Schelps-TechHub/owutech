...
echo '   
                     ...
                     <div class="body">
                        ...
                        <div class="checkbox">
                         ...
                         <div class="row clearfix" id="butt"> 
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-8">
                                    <button type="reset" onclick = " window.location='../pages/formcheck.php'"class="btn btn-raised btn-warning btn-lg btn-block btn-round waves-effect"><h6>Back </h6> </button>
                                </div>   
                    ...
                    <div class="body" style="display: none" id="addition">
                            <section>
                                 <div class="header">
                         ...
                         <div class="row clearfix">
                            <p>Additional Registration Documents to be submitted at the Admission Office</p><br>
                         </div><div class="checkbox">
                                <input  type="checkbox" >
                                <label ><p>1. Admission Registration Form Print Out</p></label>
                            </div>  
                            <div class="checkbox">
                                <input  type="checkbox" >
                                <label ><p>2. SSCE O'Level Result - Statement of Result(s) / Certificate(s)</p></label>
                            </div> 
                            <div class="checkbox">
                                <input  type="checkbox" >
                                <label ><p>3. Birth  Certificate / Age Declaration</p></label>
                            </div>
                            <div class="checkbox">
                                <input  type="checkbox" >
                                <label ><p>4. Certificate of Origin</p></label>
                            </div>
                            <div class="checkbox">
                                <input  type="checkbox" >
                                <label ><p>5. Affidavit of Good Conduct</p></label>
                            </div>
                            <div class="checkbox">
                                <input  type="checkbox" >
                                <label ><p>6. Deposit Slip / Evidence of Payment of &#8358;15,000 Admission Processing Fee </p></label>
                            </div>
