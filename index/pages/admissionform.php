                    ...
                    <div class="body">
                            <section>
                                 <div class="header">
                                     ...
                                     <br>
                                     <br>
                                     <a ><img src="../backend/<?php echo   $_SESSION['passport']?>"  width="150" height="150" alt="profile-image"></a>
...
?>
                     ...
                     <div class="body">
                            ...
                            <div class="row clearfix">
                         <div class="col-lg-4 col-md-4 col-sm-8">
                             <label for="referral"><small> Referral Code - Optional </small></label>    
                                <div class="form-group">
                                 <input type="text" name="referral" id="referral" class="form-control" placeholder="referral code" tabindex="50">
                                   </div>
                               </div>
                        </div>
                                 <div class="header">
