            ...
            <div class="row">
                <div class="col-lg-8 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">View Incomplete Applicant Forms</li>
                    </ul>
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Stage I - </strong>Incomplete Registration Forms </h2>
...
LEFT JOIN form_contact ON form_owner.regnum = form_contact.regnum 
...
echo '
                                        <tr>
                                            ...
                                            <td>'.$row["regid"].'</td>
                                            <td>'.$row["firstname"]." ".$row["othername"]." ".$row["surname"].'<br><br>'.$row["phonenum"].'</td>
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Stage II - </strong> Incomplete Registration Forms </h2>
