                    ...
                    <div class="body">
                            ...
                            <div class="header">
                                 <p><strong>Registration Form Number :: <?php echo $formnum; ?> </strong></p>
                                     ...
                                     <div class="header">
                                 <a ><img src="../../index/backend/<?php echo   $_SESSION['passport']?>"  width="100" height="100" alt="profile-image"></a><br>
...
echo '   
                    ...
                    <p><strong>Filled and Submitted by :: <?php echo strtoupper($owner); ?></strong></p>
                     ...
                     <div class="body">
                        ...
                        <br><br> <table class="deinfo" width="250" border="0" valign="top" cellpadding="4" style="border:1px solid #04abe7;">
						<tbody>
                        <tr bgcolor="#04abe7">
							<td colspan="2" class="tableDataHeader"><span class="header">SUPPORTING DOCUMENT - <?php echo $olevel?></span></td>
						</tr>
						<tr>
							<td ><iframe src="../../index/backend/docs/<?php echo $olevel?>" height="600" width="800"  title="<?php echo $olevel?>"></iframe></td>
						</tr>
						...
						<tr>
							<td ><iframe src="../../index/backend/docs/<?php echo $birth_cert?>" height="600" width="800"  title="<?php echo $birth_cert?>"></iframe></td>
						</tr>
						<tr bgcolor="#04abe7">
							<td colspan="2" class="tableDataHeader"><span class="header">SUPPORTING DOCUMENT - <?php echo $cert_origin?></span></td>
						</tr>
						<tr>
							<td ><iframe src="../../index/backend/docs/<?php echo $cert_origin?>" height="600" width="800"  title=" <?php echo $cert_origin?>"></iframe></td>
						</tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body"> 
                <div class="header">
                   <a ><img src="../../index/backend/<?php echo   $_SESSION['passport']?>"  height="100" width="100" alt="profile-image"></a><br>
