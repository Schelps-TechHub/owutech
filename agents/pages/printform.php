	...
	<tbody><tr>
		...
		<table width="750" border="0" cellpadding="6" cellspacing="0" style="border:2px solid #04abe7;">
			<tbody><tr>
				...
				<td rowspan="9" align="center" valign="middle" style="border-left:2px solid #04abe7;border-top:1px solid #ffffff;"><img name="no_photo" src="../../index/backend/<?php echo   $_SESSION['passport']?>" width="150"   height="150" alt=""></td>
			</tr>
			<tr>
